<template>
  <div class="amap-page-container">
    <el-amap vid="amapDemo" :zoom="zoom" :center="center" class="amap-demo">
      <!--台风图片-->
      <el-amap-ground-image class="icon" style="height: 200px; width:200px" v-for="groundimage in groundimages" :url="groundimage.url" :bounds="groundimage.bounds" :events="groundimage.events"></el-amap-ground-image>
      <!--绘制折线-->
  ...
  export default {
    data() {
      return {
        ...
        groundimages: [
          {
            url: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1550828782039&di=f7a606f8413c5c747fda119912176bc3&imgtype=0&src=http%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz%2F3XDoxIyMpKQE0ibicQvDCS7Vkrqr00oxICAaNskR7XI9ahnia9Wg9n1fBvXONlPSZXwObgHbkaz69kib9MoyrEEia8A%2F0%3Fwx_fmt%3Dgif',
            // url:'../../static/typhoon.png',
            bounds: [[106,25.0],[107.3,24.7]],
            events: {
              click() {
